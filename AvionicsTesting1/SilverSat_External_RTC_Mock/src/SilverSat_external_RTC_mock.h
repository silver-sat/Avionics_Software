/**
 * @file Silversat_external_RTC_mock.h
...
#ifndef SILVERSAT_EXTERNAL_RTC_MOCK_H
#define SILVERSAT_EXTERNAL_RTC_MOCK_H
...
*/
/**************************************************************************/
class ExternalRTC : RTC_I2C {
public:
  bool begin(int wireInstance = 0);
...
private:
  DateTime _datetime {2022, 1, 1, 10, 0, 0};

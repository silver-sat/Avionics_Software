/**
 * @file SilverSat_external_RTC_mock.cpp
 * @author Lee A. Congdon (lee@silversat.org)
 * @brief Mock external Real Time Clock for demonstration and testing
 * @version 1.0.0
 * @date 2022-07-12
 *
 * Based on Adafruit RTClib
 */
 ...
 *
 * @param wireInstance not used
 * @return true always
 */
bool ExternalRTC::begin(int wireInstance)
{
    return true;
};
 ...
 * @brief Set the clock
 *
 * @param dt date and time class
 */
void ExternalRTC::adjust(const DateTime &dt) {
    _datetime = DateTime(dt);
    _isrunning = true;
};

/**
 * @brief Check is clock is running
 * 
 * @return uint8_t 
 */
uint8_t ExternalRTC::isrunning(void) {
    return _isrunning;
};

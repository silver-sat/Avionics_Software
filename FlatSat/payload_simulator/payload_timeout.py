##
# @file payload_timeout.py
# @brief FlatSat simulate Payload Board timeout
# @author Lee A. Congdon (lee@silversat.org)
# @version 1.0.0
# @date 8 May 2023

"""FlatSat simulate Payload Board timeout"""
...
print("Starting Payload Board timeout simulator")
    ...
    if simulator_state == simulator_running:
        if state_transition:
            ...
            if (states_a.value + states_b.value + states_c.value) < 2:
                print("Photo mode")
                timer_end = time.monotonic() + timeout_time
            else:
